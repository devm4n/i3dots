...
c.colors.statusbar.normal.bg = "#0C0E1B"
c.colors.statusbar.command.bg = "#0C0E1B"
...
# fonts
c.fonts.default_family = ['FiraCodeNerd Font Mono 8']
c.fonts.default_size = '13pt'
c.fonts.web.family.fixed = '0xProtoNerdFont Regular 12'
